#ifndef __SIMPLEFI_PROTOCOLS_SERVICES_BOOT_EVENT_TIME_SERVICE_H
#define __SIMPLEFI_PROTOCOLS_SERVICES_BOOT_EVENT_TIME_SERVICE_H
...
using EfiEventNotifyFn = VOID (EFIAPI *)(
    EFI_EVENT Event,
    VOID* Context
);

using EfiCreateEventFn = EFI_STATUS (EFIAPI *)(
    UINT32 Type,
    EfiTPL NotifyTpl,
    EfiEventNotifyFn NotifyFunction,
    VOID* NotifyContext,
    EFI_EVENT* Event
);

using EfiCreateEventExFn = EFI_STATUS (EFIAPI *)(
    UINT32 Type,
    EfiTPL NotifyTpl,
    EfiEventNotifyFn NotifyFunction,
...
using EfiCloseEventFn = EFI_STATUS (EFIAPI *)(
    EFI_EVENT Event
);

using EfiSignalEventFn = EFI_STATUS (EFIAPI *)(
    EFI_EVENT Evvent
);

using EfiWaitForEventFn = EFI_STATUS (EFIAPI *)(
    UINTN NumberOfEvents,
    EFI_EVENT* Event,
    UINTN* Index
);

using EfiCheckEventFn = EFI_STATUS (EFIAPI *)(
    EFI_EVENT Event
);

using EfiSetTimerFn = EFI_STATUS (EFIAPI *)(
    EFI_EVENT Event,
    EfiTimerDelay Type,
    UINT64 TriggerTime
);
